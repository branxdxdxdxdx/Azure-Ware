...
if not (isfolder('AzureWare')) then
    makefolder('AzureWare')
end

if not (isfolder('AzureWare/AudioStorage')) then
    makefolder('AzureWare/AudioStorage')
end

local UI = game:GetObjects('rbxassetid://9412567399')[1]
